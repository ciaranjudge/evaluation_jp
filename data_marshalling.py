...
ists_months_df = ists_files_df.loc[ists_files_df["is_lr_reporting_date"]==True]
...
# %%
query = """
    SELECT * FROM ists_extracts 
    WHERE lr_flag = 1 AND lr_date = '2014-01-31 00:00:00.000000'
"""
%time df = pd.read_sql_query(query, engine)

df.groupby(["lr_date", "lr_flag"])["unique_id"].count()
